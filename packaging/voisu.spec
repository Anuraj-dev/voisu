...
%changelog
* Mon Sep 21 2026 Voisu maintainers <voisu@example.invalid> - 0.63.0-1
- feat(ubuntu): support GNOME setup and native overlay

* Sat Sep 19 2026 Voisu maintainers <voisu@example.invalid> - 0.62.2-1
- fix(ir): point Groq reconciliation at qwen/qwen3.8-27b (#275)

* Fri Sep 11 2026 Voisu maintainers <voisu@example.invalid> - 0.62.1-1
- test(delivery): pin clipboard recovery failure and budget semantics
- fix(delivery): recover a stale Wayland selection once, then retry

* Fri Sep 11 2026 Voisu maintainers <voisu@example.invalid> - 0.62.0-1
- fix(worker): correct cgroup join ordering, close x32 and Landlock gaps
- fix(worker): fail the sandbox gate closed when delegation is absent
- feat(worker): enforce Local sandbox and resource cgroup (#266)

* Fri Sep 11 2026 Voisu maintainers <voisu@example.invalid> - 0.61.0-1
- test(worker): assert read_capped contract instead of exact kept length
- feat(local-worker): truthful persistent Local worker (#265)

* Fri Sep 11 2026 Voisu maintainers <voisu@example.invalid> - 0.60.1-1
- docs(bakeoff): attest frozen corpus metadata
- fix(bakeoff): require complete privacy-safe reports
- docs(bakeoff): document runtime/model/tool lock and public-report check
- fix(bakeoff): freeze runtime/model hashes, scoring-tool lock, public-report gate
- fix(bakeoff): enforce real speech and scoring contract

* Thu Sep 10 2026 Voisu maintainers <voisu@example.invalid> - 0.60.0-1
- refactor(local): remove unused unavailable worker
- fix(local): gate production Local behind evidence, rename Pilot Candidate
- test(local): assert setup download safety message
- fix(local): unblock pilot install and host-proof the suite
- feat(local): Arch pilot offline path on whisper-cli base.en

* Wed Sep 09 2026 Voisu maintainers <voisu@example.invalid> - 0.59.0-1
- feat(packaging): add Local ASR profile and rollback contracts (#260)

* Wed Sep 09 2026 Voisu maintainers <voisu@example.invalid> - 0.58.0-1
- feat(local): present truthful Local status, doctor, Setup, and Overlay (#259)

* Wed Sep 09 2026 Voisu maintainers <voisu@example.invalid> - 0.57.0-1
- feat(local): route Cloud vs Local before constructing dependencies (#258)

* Tue Sep 08 2026 Voisu maintainers <voisu@example.invalid> - 0.56.0-1
- feat(local): add catalog installer and supervised worker (#257)
...
* Tue Sep 08 2026 Voisu maintainers <voisu@example.invalid> - 0.53.0-1
- feat(config): enable Intent Reconstruction from writing smart

* Tue Sep 08 2026 Voisu maintainers <voisu@example.invalid> - 0.52.0-1
- feat(delivery): paste Hyprland transcripts through send_key_state

* Mon Sep 07 2026 Voisu maintainers <voisu@example.invalid> - 0.51.0-1
- feat(ir): join letter-by-letter spellings in Intent Reconstruction

* Sat Sep 05 2026 Voisu maintainers <voisu@example.invalid> - 0.50.0-1
- feat(config,replay): transcription language surface + machine-readable replay

* Sat Sep 05 2026 Voisu maintainers <voisu@example.invalid> - 0.49.0-1
- feat(reconcile): confidence-aware divergence arbitration + Groq word confidences
