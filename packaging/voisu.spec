...
BuildRequires:  pkgconfig(gtk4-layer-shell)
BuildRequires:  pkgconfig(xkbcommon)

# These are actual external boundaries in system.rs: wl-copy/wl-paste,
# pw-record/wpctl, curl, and secret-tool. libei is dlopen()'d by SONAME and is
# therefore an optional runtime capability rather than a hard build/link dep.
...
cargo build --release --locked -p voisu-app --features overlay --bin voisu-overlay

%check
cargo test --release --locked --workspace
cargo check --release --locked -p voisu-app --features overlay
